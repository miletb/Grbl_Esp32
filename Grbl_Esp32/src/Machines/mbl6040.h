...
#define Y_LIMIT_PIN             GPIO_NUM_23
//#define Z_LIMIT_PIN             GPIO_NUM_16 // treba da bude 18
...
#define CONTROL_RESET_PIN       GPIO_NUM_18  // treba da bude 16,  labeled Reset, needs external pullup
